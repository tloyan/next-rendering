...
Avec Next il est facile de generer des MétaData (utile pour le SEO) pour cela il suffit d’exporter `export const metadata`
...
Il est possible de générer des MétaData de manière dynamique
...
📑 Le lien vers la doc [https://nextjs.org/docs/app/building-your-application/optimizing/metadata#dynamic-metadata](https://nextjs.org/docs/app/building-your-application/optimizing/metadata#dynamic-metadata)

**🐶**Dans cet exercice génère les métaData pour ces routes dynamique
